export const text = `('duzzle.com'이하 'Duzzle')은(는) 「개인정보 보호법」 제30조에 따라 
정부주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 
하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.

○ 이 개인정보처리방침은 2021년 5월 1일부터 적용됩니다.

 

제1조(개인정보의 처리 목적)

('duzzle.com'이하 'Duzzle')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 
...
① Duzzle은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 
...
① Duzzle은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 
정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 
해당하는 경우에만 개인정보를 제3자에게 제공합니다.
② Duzzle은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.

개인정보를 제공받는 자 : Duzzle 서비스 이용자
제공받는 자의 개인정보 이용목적 : 이메일, 이름, 부서, 직업, 학력
제공받는 자의 보유.이용기간: 서비스 내에서만 이용
 
 

제5조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)

① 정보주체는 Duzzle에 대해 언제든지 개인정보 
열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
② 제1항에 따른 권리 행사는 Duzzle에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 
서면, 전자우편 등을 통하여 하실 수 있으며 Duzzle은(는) 이에 대해 지체 없이 조치하겠습니다.
③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 
대리인을 통하여 하실 수 있습니다. 이 경우 “개인정보 처리 방법에 관한 고시(제2020-7호)” 
...
⑥ Duzzle은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리 정지의 요구 시 
...
① Duzzle은(는) 다음의 개인정보 항목을 처리하고 있습니다.
< 홈페이지 회원가입 및 관리 >
필수항목 : 이메일, 비밀번호, 이름, 직업, 학력, 접속 로그, 쿠키
선택항목 : 부서
...
① Duzzle은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 
...
1. 파기절차
Duzzle은(는) 파기 사유가 발생한 개인정보를 선정하고, 
Duzzle의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
2. 파기방법
...
Duzzle은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
...
① Duzzle 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 
...
가. 쿠키의 사용 목적 : 사용자 로그인 서비스를 제공하기 위해 사용됩니다. 
...
① Duzzle 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 
...
담당자 : 노주현
연락처 : DuzzleManager@gmail.com,
② 정보주체께서는 Duzzle 의 서비스(또는 사업)을 이용하시면서 발생한 
모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 
개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 
Duzzle 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
...
Duzzle 은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
